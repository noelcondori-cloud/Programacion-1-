...
// Problema planteado:7 Programa que declare un vector de diez elementos enteros y pida números para
...
vector<int> ingresar(){
    ...
    while(i < 10 && a >= 0){//funcion menor que 10 o mayor igual que 0
