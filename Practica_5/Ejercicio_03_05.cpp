...
// Problema planteado:3. Escriba un programa para introducir los N números enteros en un arreglo llamado calificaciones
...
//cuadrado cada desviación individual y dividiendo la suma de las desviaciones cuadradas entre el número de desviaciones.
#include <iostream>
#include <vector>
#include <math.h>
